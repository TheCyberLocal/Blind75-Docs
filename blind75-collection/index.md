...
- [Decode Ways](./1d-dynamic-programming/decode-ways/problem.md)
- [House Robber](./1d-dynamic-programming/house-robber/problem.md)
- [House Robber II](./1d-dynamic-programming/house-robber-ii/problem.md)
- [Longest Increasing Subsequence](./1d-dynamic-programming/longest-increasing-subsequence/problem.md)
- [Longest Palindromic Substring](./1d-dynamic-programming/longest-palindromic-substring/problem.md)
- [Maximum Product Subarray](./1d-dynamic-programming/maximum-product-subarray/problem.md)
...
## 2D Dynamic Programming - _Empty_
...
- [Group Anagrams](./arrays-and-hashing/group-anagrams/problem.md)
- [Longest Consecutive Sequence](./arrays-and-hashing/longest-consecutive-sequence/problem.md)
- [Product of Array Except Self](./arrays-and-hashing/product-of-array-except-self/problem.md)
- [Top K Frequent Elements](./arrays-and-hashing/top-k-frequent-elements/problem.md)
- [Two Sum](./arrays-and-hashing/two-sum/problem.md)
- [Valid Anagram](./arrays-and-hashing/valid-anagram/problem.md)

## Backtracking - _Empty_

- [Combination Sum](./backtracking/combination-sum/problem.md)
- [Word Search](./backtracking/word-search/problem.md)

## Binary Search - _Empty_
...
- [Number of Connected Components in an Undirected Graph](./graphs/number-of-connected-components-in-an-undirected-graph/problem.md)
...
- [Meeting Rooms II](./intervals/meeting-rooms-ii/problem.md)
...
- [Merge Two Sorted Lists](./linked-list/merge-two-sorted-lists/problem.md)
- [Remove Nth Node from End of List](./linked-list/remove-nth-node-from-end-of-list/problem.md)
- [Reorder List](./linked-list/reorder-list/problem.md)
- [Reverse Linked List](./linked-list/reverse-linked-list/problem.md)

## Math and Geometry - _Empty_
